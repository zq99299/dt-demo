package cn.mrcode.dtdemo.generator;
...
public class MyBatisPlusGeneratorTest {
    static String url = "jdbc:mysql://mrcode.cn:3306/dt_demo_a?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8&useSSL=false";
    static String username = "root";
    static String password = "123456";
    static String parentPackage = "cn.mrcode.dtdemo.a.repo";
